...
Usage
- Use Bash for build/test/run commands.md or system utilities that are not covered by other tools.
- Do NOT use shell commands.md for listing/searching/reading files:
  - Use LS for listing, Read for file contents, Grep for content search, Glob for filename search.
- Avoid interactive commands.md (vim/nano/top/htop/ssh/git rebase -i, etc.) — they are blocked.
